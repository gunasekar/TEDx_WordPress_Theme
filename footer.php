	...
	<nav id="mainNav">
		<div align="center"><a href="http://www.ted.com/" target="_blank" title="Back to TED.com">« Back to TED.com</a></div>
		<a href="<?php echo home_url(); ?>" class="logo_sm">tedx</a>
	
    	<?php wp_nav_menu(array('theme_location' => 'primary_navigation', 'depth' => 1)); ?>
		
		<ul class="clearfix">
			<li><a href="http://twitter.com/#!/tedx/">Twitter</a></li>
			<li><a href="http://www.facebook.com/tedx">Facebook</a></li>
	...
	<footer class="row">
		...
		<section class="recentTweet three columns clearfix">
			...
			<span style="float:right;">tedx on <a href="http://twitter.com/tedx/">Twitter.com</a></span>
		...
		<section class="legalStuff three columns clearfix">
			...
			© 2012 tedx. All rights reserved.</p>
		</section>
