			...
			<article <?php post_class() ?> id="post-<?php the_ID(); ?>">
				...
				<div class="row">
					...
					<aside class=" four columns speakerDetails">
						...
						<?php 
						$speaker_twitterID = get_post_meta($post->ID, '_tedx_speaker_twitterID_value', true);
						$speaker_email = get_post_meta($post->ID, '_tedx_speaker_email_value', true);
						$speaker_website = get_post_meta($post->ID, '_tedx_speaker_website_value', true);
					...
					<div class="eight columns entry-content">
						...
						<?php if (get_post_meta($post->ID, '_tedx_speaker_tedtalk_value', true)) : ?>
						<div class="video_wrapper">
							<div class="video_container">
								<iframe width="560" height="315" src="http://www.youtube.com/embed/<?php echo get_post_meta($post->ID, '_tedx_speaker_tedtalk_value', true) ?>" frameborder="0" allowfullscreen></iframe>
							</div>
						</div>
						<?php endif; ?>
