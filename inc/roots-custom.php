...
function tedx_register_sidebars() {
...
add_action('widgets_init', 'tedx_register_sidebars');
...
// Add tedx logo and redirect link
...
function custom_menu_order($menu_ord){
	...
	return array(
		'index.php',
		'edit.php',
		'edit.php?post_type=tedx_speaker',
		'edit.php?post_type=tedx_committee',
...
function create_year_taxonomy() {
	$labels_year = array(
  	...
  	register_taxonomy('tedxYear','speakers',array(
    	'hierarchical' => false,
    	'labels' => $labels_year,
...
function create_category_taxonomy() {
	$labels_category = array(
    	'name' => __( 'Sponsor Category' ),
    	'singular_name' => __( 'Sponsor Category' ),
    	'search_items' =>  __( 'Search Sponsor Category' ),
    	'all_items' => __( 'All Sponsor Category' ),
  	...
  	register_taxonomy('tedxCategory','sponsors',array(
    	'hierarchical' => false,
